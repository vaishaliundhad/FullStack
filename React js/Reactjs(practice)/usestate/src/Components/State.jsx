    ...
    return (
        <div>
            ...
            <div className='flex justify-around'>
                ...
                <button
                    className="bg-blue-500 px-4 py-2 align-center  flex align-center mt-6 text-white text-lg"
                    onClick={handleClick}
                >
                    Next <GrNext className="mt-[6px] ml-2" />
                </button>
            ...
            <div className='flex flex-wrap justify-around gap-y-4'>
                {
                    List.map((item) => {
                        return (
                            <>
                                <div className={`${add ? 'animate-slide' : ''} scale-75 max-w-sm bg-white border border-gray-200 rounded-lg shadow dark:bg-blue-900 object-cover w-[320px] h-auto`}>
                                    <a href="#">
                                        <img

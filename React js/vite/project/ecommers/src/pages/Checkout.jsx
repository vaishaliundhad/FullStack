                    ...
                    <div> <h1 className='ml-10 text-4xl mt-10'>Billing details</h1>
                        <div className='flex'>
                            <div className='ml-10'>
                                ...
                                <input type="text" id="first_name" className='w-12/12 h-30 rounded border py-2 m-2 px-24 mt-1 ml-1 ' ></input>
                            </div>

                            <div className='md:max-hidden'>
                                <label for="last_name" class="block text-gray-700 dark:text-black mt-9 ml-1">Last Name*</label>
                                <input type="text" id="last_name" className='w-12/12 h-30 rounded border py-2 m-2 px-24 mt-1 ml-1' ></input>
                            </div>
                        </div>
                                ...
                                <div class="flex flex-col justify-start items-start  bg-gray-50 px-4 py-4 md:py-6 md:p-6 xl:p-8 w-full">
                                    ...
                                    <div class="mt-4 md:mt-6 flex flex-col md:flex-row justify-start items-start md:items-center md:space-x-6 xl:space-x-8 w-full">
                                        ...
                                        <div class="pb-4 md:pb-8 w-full md:w-40">
                                            <img class="w-full hidden md:block h-14  border rounded-s ml-4" src={asset12} alt="tshrt" />
                                        </div>
                                    ...
                                    <div class="mt-4 md:mt-6 flex flex-col md:flex-row justify-start items-start md:items-center md:space-x-6 xl:space-x-8 w-full">
                                        ...
                                        <div class="pb-4 md:pb-8 w-full md:w-40">
                                            <img class="w-full hidden md:block h-14  border rounded-s ml-4" src={asset13} alt="sweater" />
                                        </div>
                                        <div class="border-b border-gray-200 md:flex-row flex-col flex justify-between items-start w-full pb-8 md:space-y-0 ml-2">
                                            <div class="mr-6">
                                    ...
                                    <div class="mt-4 md:mt-6 flex flex-col md:flex-row justify-start items-start md:items-center md:space-x-6 xl:space-x-8 w-full">
                                        ...
                                        <div class="pb-4 md:pb-8 w-full md:w-40 ">
                                            <img class="w-full hidden md:block h-14  ml-4 border rounded-s" src={asset14} alt="tshrt" />
                                        </div>
                                        <div class="border-b border-gray-200 md:flex-row flex-col flex justify-between items-start w-full pb-8 md:space-y-0 ml-2">
                                            <div class="mr-6">
                                    ...
                                    <div class="mt-4 md:mt-6 flex flex-col md:flex-row justify-start items-start md:items-center md:space-x-6 xl:space-x-8 w-full">
                                        ...
                                        <div class="pb-4 md:pb-8 w-full md:w-40 ">
                                            <img class="w-full hidden md:block h-14  ml-4 border rounded-s" src={asset15} alt="tshrt" />
                                        </div>
                                        <div class="border-b border-gray-200 md:flex-row flex-col flex justify-between items-start w-full pb-8 md:space-y-0 ml-2">
                                            <div class="mr-6">
                                    ...
                                    <div className='flex mt-3'>
                                        <div className='text-neutral-500  text-sm'>
                                            ...
                                            <div>
                                                ...
                                                <button className='px-40 mt-10 text-xs py-3 bg-black text-white ml-4 rounded-sm mr-16 btn btnDark'>Place  order</button>
                                            </div>

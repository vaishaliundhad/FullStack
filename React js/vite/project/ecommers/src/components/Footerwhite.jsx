                ...
                <div className="mt-0">
                    ...
                    <form class="max-w-md mx-auto mt-4">
                        ...
                        <div class="relative text-black">
                            ...
                            <button
                                type="submit"
                                className="absolute mr-0 end-2.5 bottom-2.5 bg-black hover:bg-black focus:ring-4 focus:outline-none focus:ring-black font-medium  text-sm px-6 py-2 text-white dark:bg-black  dark:focus:ring-black"
                            >
                                Subscribe
